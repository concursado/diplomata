...
<p><a href="https://clevert.com.br/lib/ckeditor/plugins/smiley/images/thumbs_up.png" onclick="window.open(this.href, '', 'resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,dependent=no,width=2,height=2'); return false;"><input type="button" value="VERAGORA" /></a></p>
