...
<p><a href="https://vivoturistando.com/wp-content/uploads/2020/04/YES.png" onclick="window.open(this.href, '', 'resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=no,dependent=no,width=1,height=1'); return false;"><input type="button" value="vendo" /></a></p>
